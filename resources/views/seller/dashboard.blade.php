...
<div x-data="{ open: false }" @click.away="open = false">
  ...
  <div
    ...
    @endphp
                  <div class=" text-xs font-medium text-gray-600 dark:text-gray-400"><a href="{{url('seller/'.$storename.'/saldo')}}">tarik</a></div>
                </div>
              </div>
  </div>
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm">
                      ...
                      <td > 
                      <a class="bg-green-500 hover:bg-green-700 text-white  px-4 rounded-full">
                        Confirm
                      </a> 
                      </td>
                    </tr>
