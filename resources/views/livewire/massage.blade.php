        ...
        <div class="flex-1 p:2 justify-between flex flex-col h-screen">
            <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200 ">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex flex-col leading-tight">
                        <div class="text-2xl mt-1 flex items-center">
                        <span class="text-gray-700 mr-3">{{ $clicked_user->first_name }}</span>
                    ...
                    @elseif($admin->is_online)
                        <div class="text-2xl mt-1 flex items-center">
                        <span class="text-gray-700 mr-3">We are online</span>
                        <span class="text-green-500">
                            <svg width="10" height="10">
                                <circle cx="5" cy="5" r="5" fill="currentColor"></circle>
                            </svg>
            ...
            <div id="messages" class="flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
                ...
                @else
                    ...
                    @else
                        No messages to show
                    @endif
                    @if(!isset($clicked_user) and auth()->user()->roles_id == 3)
                        ...
                        @if ($users != null)
                            ...
                            @foreach ($users as $user)
                                @php
                                    ...
                                    $not_seen = \App\Models\Message::where('user_id', auth()->id())->where('receiver', $user->id)->where('is_seen', false)->get() ?? null;
                    ...
                    <div class="card-body message-box">
                        ...
                        @else
                            ...
                            @else
                                No messages to show
                            @endif
                            @if(!isset($clicked_user) and auth()->user()->role_id == 3)
                                Click on a user to see the messages
                            @endif
                        @endif
                    </div>
