        ...
        <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-2 py-3">
            ...
            <div class="my-1 px-1 w-full  overflow-hidden">
                ...
                <div class="flex justify-end" id="store-nav-content">
                    <div class="pl-3 inline-block no-underline hover:text-black" id="search-content">
                        <input type="search" name="search" wire:model="searchTerm" class="shadow appearance-none border rounded w-full py-1 px-4 text-gray-500" placeholder="Search" >
                    </div>
                    <a class="pl-3 inline-block no-underline hover:text-black" id="nav-toggle">
