<nav id="header" class="w-full z-30 top-0 py-1 border-b-2 border-black">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3 ">
        ...
        <div class="order-2 md:order-3 flex items-center" id="nav-content">
            ...
            <button @click="dropdownOpen2 = !dropdownOpen2" class="relative z-10 block rounded-md bg-white focus:outline-none lg:m-1">
                ...
                <button @click="dropdownOpen = !dropdownOpen" class="relative z-10 block rounded-md bg-white p-2 focus:outline-none">
                    ...
                    @if (Route::has('register'))
                        ...
                        <div class="relative w-10">
                            <div class="flex relative w-8 h-8 bg-red-500 justify-center items-center m-1 mr-2 text-xl  text-white rounded-full border border-gray-100 uppercase">{{ Str::limit(Auth::user()->first_name, 1,'') }}</div>
                        </div>
                    @endguest
            ...
            <div x-show="dropdownOpen" @click="dropdownOpen = false" class="fixed inset-0 h-full w-full z-10"></div>
                ...
                <div x-show="dropdownOpen" class="absolute right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
                    ...
                    @if ($verify != Null)
                        ...
                        <a href="{{url('/myorder/'.\Crypt::encrypt($data))}}" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-blue-500 hover:text-white">
                        Pesanan
                        </a>
