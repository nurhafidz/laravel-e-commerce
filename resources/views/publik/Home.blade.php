...
<div class="carousel relative container mx-auto" style="max-width:1600px;">
    ...
    <div class="carousel-inner relative overflow-hidden w-full">
        <!--Slide 1-->
        <input class="carousel-open geser " type="radio" id="carousel-1" name="carousel" aria-hidden="true" hidden="" checked="checked">
        ...
        <!--Slide 2-->
        <input class="carousel-open geser " type="radio" id="carousel-2" name="carousel" aria-hidden="true" hidden="" >
        ...
        <!--Slide 3-->
        <input class="carousel-open geser transition-all ease-in-out duration-1000" type="radio" id="carousel-3" name="carousel" aria-hidden="true" hidden="">
        <div class="carousel-item absolute opacity-0 transition-all ease-in-out duration-1000" style="height:50vh;">
        ...
        <ol class="carousel-indicators">
            <li class="inline-block mr-3">
                <label for="carousel-1" class="carousel-bullet dot cursor-pointer block text-4xl text-gray-400 hover:text-gray-900">•</label>
            </li>
            <li class="inline-block mr-3">
                <label for="carousel-2" class="carousel-bullet dot cursor-pointer block text-4xl text-gray-400 hover:text-gray-900">•</label>
            </li>
            <li class="inline-block mr-3">
                <label for="carousel-3" class="carousel-bullet dot cursor-pointer block text-4xl text-gray-400 hover:text-gray-900">•</label>
            </li>
        </ol>
    </div>
</div>
